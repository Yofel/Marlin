...
#define STRING_CONFIG_H_AUTHOR "(Yofel, Geeetech Prusa i3 Pro B custom config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Geeetech defaults use Ultimaker, so stick with that
